...
declare class _Base {
  ...
  exists(): this;
  present(): this;
  allow(...values: unknown[]): this;
  equal(...values: unknown[]): this;
  is(...values: unknown[]): this;
  deny(...values: unknown[]): this;
  disallow(...values: unknown[]): this;
  not(...values: unknown[]): this;
  options(opts: base.ValidationOptions): this;
  prefs(opts: base.ValidationOptions): this;
  preferences(opts: base.ValidationOptions): this;
